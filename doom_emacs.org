...
(use-package! projectile
  ...
  :config
  (setq projectile-add-known-project '("~/Documentos/Hardware/" "~/Documentos/Topicos Mapas" "~/Documentos/Tesis/")))
#+end_src
...
(customize-set-variable 'dotfiles-org-files '("awesome.org" "doom_emacs.org"))
#+end_src
